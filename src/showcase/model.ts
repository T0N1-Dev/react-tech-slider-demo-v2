...
import { type BrandDatasetValidation, validateBrandDataset } from "./brands";
...
export function normalizeColor(
  ...
  return resolved
    ? { value: resolved.canonical, status: "valid" }
    : { value: previous, status: "invalid" };
}
...
function normalizedColorValue(
  ...
  return normalizeColor(raw, previous, resolveColor).value;
}
  ...
  return (
    ...
    switch (action.type) {
      ...
      case "SET_DATASET":
        return {
          ...state,
          shared: { ...state.shared, datasetId: action.value },
        };
      case "SET_ICON_WIDTH":
        return {
          ...state,
